...
let keyboard = [96, 49, 50, 51, 52, 53, 54, 55, 56, 57, 48, 45, 61, "Backspace", "Tab", 113, 119, 101, 114, 116, 121, 117, 105, 111, 112, 91, 93, 92, 'Del', "Caps Lock", 97, 115, 100, 102, 103, 104, 106, 107, 108, 59, 39, 13, 'Shift', 122, 120, 99, 118, 98, 110, 109, 44, 46, 47, '^', 'Shift', "Ctrl", 'Win', 'Alt', 32, 'Alt', '<', "^", ">","Ctrl"]
let keyb = [];
...
document.querySelectorAll(".k-key").forEach(function (element) {
    element.onclick = function (event) {
        ...
        document.querySelector('textarea').insertAdjacentText('beforeend', this.textContent)
    }
});
function setFocus(){
...
//     var items = document.querySelectorAll(".k-key")
